...
let buttonList = [  //array - list
button1,button2,button3,button4,button5,button6,button7,button8,button9,
]

gameplay()// fuction call



function gameplay(){ // fuction defantion
buttonList.forEach(button => {
    button.onclick = () => {//arrow function
        console.log("CLICK")
        let pTag = button.children[0]
        if(currentTurn % 2 == 0){
            currentTurn++; //iltertor adds 1 
...
function checkWin(){
    ...
    if( button1.textContent.trim() == "O" &&  button2.textContent.trim() == "O" &&  button3.textContent.trim() == "O" ||
